  ...
  return (
    <div className='flex flex-col md:flex-row md:gap-5 justify-between items-center'>
      <div className='flex flex-col md:gap-4 gap-5 md:ml-5'>        
          ...
          <h1 className='text-5xl md:text-8xl'><span className='text-primary'>Fullstack</span> <br/> Developer</h1>
      ...
      <img className='my-12 w-4/5 border-double border-8 border-spacing-12  border-slateGray rounded-full sm:w-2/4 h-auto md:mr-10' src={picture} alt="profile" />
    </div>
  )
}
